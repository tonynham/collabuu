...
export class ContentRouter {
  ...
  constructor() {
    ...
    this.router.get('/embed-preview/:contentId', authenticateToken, this.getEmbedPreview.bind(this));
  ...
  private async recognizeLink(req: Request, res: Response) {
    try {
      const { url } = req.body;
  ...
  private async getEmbedPreview(req: Request, res: Response) {
    try {
  ...
  private async extractMetadata(req: Request, res: Response) {
    try {
      const { url } = req.body;
      ...
      const recognition = await this.recognizeLink({ body: { url } } as Request, {} as Response);
